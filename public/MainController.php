...
class MainController extends AbstractController
{
     ...
     * @Route("/", name="accueil")
     */
    public function index(Request $request, MatchAVenirRepository $nextMatchRepository, ArticlesRepository $articlesRepository, CategoryRepository $categoryRepository): Response
    {
...
//            recup de la catégorie
     ...
     */
    public function equipe($id,Request $request,EquipeRepository $equipeRepository): Response
    {
        if ($request->isXmlHttpRequest()) {
            $categoryAjax = $request->get('category');
